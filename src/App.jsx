...
import profile_pic_tablet from './assets/images/image-profile-tablet.webp'
import profile_pic_desktop from './assets/images/image-profile-desktop.webp'

import rings from './assets/images/pattern-rings.svg'
import circle from './assets/images/pattern-circle.svg'
import Project_Card from './components/Project_Card'
import { projects, projects_large } from './data'
...
function App() {
  ...
  return (
    <div className="relative w-screen h-full overflow-hidden bg-base font-portfolio_text ">
      <img
        src={rings}
        alt=""
        className="absolute transform scale-150 top-36 -left-72 md:scale-100 md:top-20 lg:top-32 lg:scale-100 lg:-left-20"
      />
      <img
        src={profile_pic_tablet}
        alt=""
        className="absolute right-0 z-40 hidden w-60 h-[30rem] md:block lg:hidden"
      />

      <img
        src={circle}
        alt=""
        className="absolute top-44 -right-12 lg:top-[24rem] lg:right-[25rem] lg:z-50"
      />

      <article className="flex flex-col items-center justify-center gap-10 overflow-hidden text-top text-text_color">
        {/* header section */}
        <section className="relative flex flex-col justify-center w-5/6 h-full gap-5 pb-20 text-center border-b-2 md:h-[36rem] md:text-left md:gap-10 lg:h-[40rem]">
          <div className="relative flex flex-col items-center justify-center w-full h-full md:flex-row md:justify-between md:absolute lg:relative">
            <h1 className="z-50 font-bold top-16 md:absolute text-m leading-m lg:top-5">
              adamkeyes
            </h1>
            <div className="z-50 w-3/5 p-2 -right-14 md:absolute top-16 md:w-1/3 lg:w-1/4 lg:right-0 lg:top-5">
              <ul className="flex justify-between md:gap-x-2 lg:justify-end lg:gap-8">
                <li>
                  <a href="#">
                    <svg
            ...
            <img
              src={profile_pic}
              alt=""
              className="w-3/5 h-80 opacity-3 md:hidden"
            />
            <img
              src={profile_pic_desktop}
              alt=""
              className="absolute top-0 right-0 hidden h-[36rem] lg:block"
            />
          </div>
          <h2 className="z-50 font-bold mobile-header md:w-3/4 md:text-[72px] md:leading-[72px] md:tracking-[-2.05px] md:mt-20 lg:text-xl lg:leading-xl lg:tracking-xl">
            Nice to meet you! I'm{' '}
            <span className="border-b-4 border-underlined">Adam Keyes.</span>
          </h2>
          <p className="font-semibold text-sm leading-m_sm text-sub_text_color md:w-[445px] lg:text-blg lg:leading-blg ">
            Based in the UK, I'm a front-end developer passionate about building
            accessible web apps that users love.
          </p>
          <h3 className="">
            <span className="pb-2 text-sm font-bold uppercase border-b-2 border-underlined leading-m_sm tracking-m_sm ">
        ...
        {/* skills section */}
        <section className="relative flex flex-col justify-center w-5/6 h-full grid-cols-2 gap-3 pb-20 text-center border-b-2 md:grid md:gap-5 md:text-left md:border-b-0 lg:grid-cols-3 ">
          <img
            src={rings}
            alt=""
            className="absolute transform scale-150 -bottom-11 -right-3/4 md:scale-100 md:-right-96 md:bottom-4"
          />
        ...
        <section className="w-5/6 ">
          <div className="flex items-center justify-between mt-10">
            <h2 className="font-bold mobile-header lg:text-xl lg:tracking-xl lg:leading-xl">
              Projects
            </h2>{' '}
            <h3 className="flex">
          ...
          <div className="grid-cols-2 gap-8 md:grid lg:hidden">
        ...
        <section className="relative flex flex-col items-center justify-center w-5/6 h-full gap-5 pb-20 border-b-2 md:border-0 md:bg-sub_base md:w-screen md:py-20 md:pb-5">
          <img
            src={rings}
            alt=""
            className="absolute transform scale-150 pointer-events-none top-[350px] -left-[350px] md:scale-100 md:-left-80  md:top-[32rem]"
          />
          <div className="flex flex-col items-center justify-center gap-5 pb-10 md:w-1/2 lg:flex-row lg:justify-between lg:w-5/6 lg:items-start ">
            <div className="flex flex-col items-center justify-center gap-5 lg:w-1/4 lg:text-left lg:items-start">
              <h2 className="font-bold text-[40px] leading-[40px] -tracking-[1.14px] md:text-[72px] md:leading-[72px] md:tracking-[-2.05px]">
                Contact
              </h2>{' '}
              <p className="w-full text-center text-sub_text_color text-m_sm leading-m_sm lg:text-left">
                I would love to hear about your project and how I could help.
                Please fill in the form, and I’ll get back to you as soon as
                possible.
              </p>
            </div>
            <form className="flex flex-col w-full gap-8 text-sub_text_color lg:w-1/3">
              <div
                className={
              ...
              >
                ...
                <input
                  ...
                  className={
                    'w-full pl-10 border-none outline-none bg-base md:bg-sub_base'
                  }
                  placeholder="NAME"
                  required
                />
              ...
              >
                <textarea
                  ...
                  className="w-full h-20 pl-10 border-none outline-none bg-base md:bg-sub_base"
                  placeholder="MESSAGE"
                ></textarea>
              </div>
              <h3 className="mt-5">
          ...
          <div className="w-full border-t-2 md:w-5/6"></div>
          <footer className="flex flex-col items-center justify-center gap-4 pb-10 md:flex-row md:justify-between md:bg-sub_base md:w-5/6 md:pb-0">
