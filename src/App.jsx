function App() {
  return (
    <div className="h-screen w-screen bg-base">
      <article className="flex flex-col gap-10 justify-center items-center text-center text-text_color">
        ...
        <section>
          ...
          showcase HTML CSS JavaScript View project View code Contact I would
          love to hear about your project and how I could help. Please fill in
          the form, and I’ll get back to you as soon as possible. Name Email
